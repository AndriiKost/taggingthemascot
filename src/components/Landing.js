...
const LandingPage = () => {
  ...
  return (
        <div className='gradientSection'>
          <h3>Welcome to the “The Once In A Lifetime Amazing 24 Hour Geo-Tag Mascot Extravaganza!!!”</h3> 
          <p style={style}>Which means in real life, “The Once In A Lifetime Amazing 24 Hour Geo-Tag Mascot Extravaganza!!!” What this event is, is a 24 hour race to tag as many of the 85 life size Mascots placed around Middleton, Sun Prairie, Verona, and Madison.</p>
          ...
          <p style={style}>Right now the 85 Mascots are out in the open and accessible to the public but on September 15th 2018 the Mascots will be auctioned off and scattered way too far to do it in 24 hours.</p>
